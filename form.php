...
<?php
    ...
    if (isset($_GET["event_id"])) { 
        ...
        $query  = "SELECT * FROM tbl_206_events WHERE event_id=".$event_id;
      ...
      <main id="main">
        <h2>הוספת אירוע חדש</h2>
                ...
                <div class="col-lg-6">
                        ...
                        <input type="text" name="officer" id="officer" class="form-control"  placeholder="קצין אחראי" required  <?php if (isset($_GET["event_id"])){ echo 'value='. $row["offcer_owner"];}?>>
                        <span class="input-group-text">קצין אחראי</span>
                    </div><br><br>
                    <div class="input-group input-group-lg">
                        <input type="text" name="loc" id="loc"  class="form-control" placeholder="מיקום" required  <?php if (isset($_GET["event_id"])){ echo 'value='. $row["location"];}?>>
                ...
                <div class="input-group input-group-lg">
                    <input type="text" name="force_Qty" id="force_Qty" class="form-control" placeholder=" כמות כוחות" aria-label="First name" required <?php if (isset($_GET["event_id"])){ echo 'value='. $row["officer_qty"];}?>>

    ...
    <section id="aside-and-main">
      <main>
        ...
        <div id="boxs">
          <ul>
            <li>
              <a href="event.html?eventId=1">
                <div class="card">
    
                    <div class="card-body">
                        <div class="row">
                           <div class="col-9">
                             <h4 class="card-title">הפגנה בהבימה תל אביב</h4>
                             <h5 class="card-subtitle mb-2 text-muted">שוטרים פעילים:8</h5>
                             <h5 class="card-subtitle mb-2 text-muted">רמת סיכון:גבוהה</h5>
                            </div>
                            <div class="col-3">
        ...
        <li>
          <a href="event.html?eventId=2">
            <div class="card">

                <div class="card-body">
                    <div class="row">
                       <div class="col-9">
                         <h4 class="card-title">הפגנה בבית רה"מ ירושלים</h4>
                         <h5 class="card-subtitle mb-2 text-muted">שוטרים פעילים:20</h5>
                         <h5 class="card-subtitle mb-2 text-muted">רמת סיכון:גבוהה</h5>
                        </div>
                        <div class="col-3">
                          <p class="date-and-time">
        ...
        <li>
          <a href="event.html?eventId=3">
            <div class="card">

                <div class="card-body">
                    <div class="row">
                       <div class="col-9">
                         <h4 class="card-title">הפגנה בהר הבית ירושלים</h4>
                         <h5 class="card-subtitle mb-2 text-muted">שוטרים פעילים:30</h5>
                         <h5 class="card-subtitle mb-2 text-muted">רמת סיכון:גבוהה</h5>
                        </div>
                        <div class="col-3">
                          <p class="date-and-time">
        ...
        <li>
          <a href="event.html?eventId=4">
            <div class="card">

                <div class="card-body">
                    <div class="row">
                       <div class="col-9">
                         <h4 class="card-title">הפגנה ברחבת חורב חיפה</h4>
                         <h5 class="card-subtitle mb-2 text-muted">שוטרים פעילים:7</h5>
                         <h5 class="card-subtitle mb-2 text-muted">רמת סיכון:בינונית</h5>
                        </div>
                        <div class="col-3">
                          <p class="date-and-time">
                            14/05/2023
